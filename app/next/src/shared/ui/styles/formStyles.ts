export const formStyles = {
  ...
  card:
    'relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white/80 p-8 shadow-card backdrop-blur-12 sm:p-10',
  header: 'space-y-3',
  eyebrow: 'inline-flex items-center gap-2 rounded-full border border-indigo-100 bg-indigo-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-indigo-700',
  ...
  checkboxRow:
    'flex items-start gap-3 rounded-xl border border-slate-200 bg-white/80 px-4 py-3 text-sm text-slate-700',
  checkbox:
    'mt-1 h-4 w-4 rounded border-slate-300 text-indigo-600 focus:ring-2 focus:ring-indigo-200',
  ...
  alert: 'rounded-xl border border-amber-100 bg-amber-50 px-4 py-3 text-sm font-semibold text-amber-800 shadow-sm shadow-amber-100',
